...
public interface DoctorSpecialtyService {
    DoctorSpecialtyDto createDoctorSpecialty(DoctorSpecialtyDto doctorSpecialtyDto, Long doctorId, Long specialtyId);
    ...
    DoctorSpecialtyResponse getAllDoctorSpecialtiesBySpecialtyId(Long specialtyId, int pageNo, int pageSize, String sortBy, String sortDir);
}
